    ...
    <div class="body-wrapper">
        ...
        <div class="col-md-9 main-content">
            <div class="col" style="margin-left: 10px; margin-top: 100px;">
                <h2 style="text-align: center">Data Admin Lapangan</h2>
            </div>

            <div class="table-responsive">
                <div class="col" style="margin-left: 300px;">
                    <div class="table-responsive mx-auto">
                        <table class="mt-5 table table-striped table-bordered mt-3">
                            ...
                            <tbody>
                                @forelse ($data as $index => $users)
                                    <tr>
                                        ...
                                        <td>{{ $users->level }}</td>
                                        <td>
                                            <form action="{{ route('blokir', $users->id) }}" method="post">
                                                @csrf
